...
yystate(22, [10|Ics], Line, Tlen, _, _) ->
    yystate(14, Ics, Line+1, Tlen+1, 8, Tlen);
...
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(21, Ics, Line, Tlen+1, 10, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 40, C =< 43 ->
    yystate(21, Ics, Line, Tlen+1, 10, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 45, C =< 57 ->
    yystate(21, Ics, Line, Tlen+1, 10, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 122 ->
    yystate(21, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(21, Ics, Line, Tlen+1, 0, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 40, C =< 43 ->
    yystate(21, Ics, Line, Tlen+1, 0, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 45, C =< 57 ->
    yystate(21, Ics, Line, Tlen+1, 0, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 122 ->
    yystate(21, Ics, Line, Tlen+1, 0, Tlen);
...
-file("src/liquid_lexer.xrl", 12).
yyaction_0(TokenChars, TokenLine) ->
     { token, { whitespace, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/1}).
-file("src/liquid_lexer.xrl", 13).
yyaction_1(TokenLine) ->
     { token, { '{{', TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/liquid_lexer.xrl", 14).
yyaction_2(TokenLine) ->
     { token, { '}}', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/liquid_lexer.xrl", 15).
yyaction_3(TokenLine) ->
     { token, { '{%', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/liquid_lexer.xrl", 16).
yyaction_4(TokenLine) ->
     { token, { '%}', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/liquid_lexer.xrl", 17).
yyaction_5(TokenLine) ->
     { token, { '|', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/liquid_lexer.xrl", 18).
yyaction_6(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/liquid_lexer.xrl", 19).
yyaction_7(TokenLine) ->
     { token, { ':', TokenLine } } .

-compile({inline,yyaction_8/3}).
-file("src/liquid_lexer.xrl", 20).
yyaction_8(TokenChars, TokenLen, TokenLine) ->
     { token, { quoted_string, TokenLine, dequote (TokenChars, TokenLen) } } .

-compile({inline,yyaction_9/3}).
-file("src/liquid_lexer.xrl", 21).
yyaction_9(TokenChars, TokenLen, TokenLine) ->
     { token, { quoted_string, TokenLine, dequote (TokenChars, TokenLen) } } .

-compile({inline,yyaction_10/2}).
-file("src/liquid_lexer.xrl", 22).
yyaction_10(TokenChars, TokenLine) ->
